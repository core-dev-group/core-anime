  ...
  return (
    <div className="mb-14 relative group/section">
      <div className="flex items-center justify-between mb-4 px-4 md:px-8">
        <h2 className="text-lg sm:text-xl md:text-2xl font-display uppercase tracking-widest text-foreground flex items-center gap-2.5 sm:gap-3">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
